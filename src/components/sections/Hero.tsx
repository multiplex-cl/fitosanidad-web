    ...
    <section className="relative overflow-hidden bg-night text-white">
      ...
      <Container className="relative">
        <div className="max-w-3xl py-24 sm:py-28 lg:py-36">
          ...
          <p
            className="animate-fade-up mt-6 max-w-2xl text-lg leading-relaxed text-white/75 sm:text-xl"
          ...
          <div className="animate-fade-up mt-9 flex flex-col gap-3 sm:flex-row" style={{ animationDelay: "160ms" }}>
            ...
            <Button href={secondaryCta.href} size="lg" variant="light">
              {secondaryCta.label}
            </Button>
          </div>
          ...
          {support && (
            <div className="animate-fade-up mt-10 border-t border-white/10 pt-6" style={{ animationDelay: "240ms" }}>
              <p className="text-base font-medium text-white/90">{support}</p>
              {supportNote && <p className="mt-1 text-sm text-white/50">{supportNote}</p>}
            </div>
          )}
        </div>
      </Container>
...
export function PageHero({
  ...
  return (
    <section className="relative overflow-hidden border-b border-line bg-mist">
      <div className="pointer-events-none absolute right-0 top-0 h-full w-1/2 opacity-50" aria-hidden>
      ...
      <Container className="relative">
        <div className="max-w-3xl py-16 sm:py-20 lg:py-24">
          ...
          <h1 className="mt-4 text-4xl font-semibold leading-[1.1] tracking-tight sm:text-5xl">{title}</h1>
